class EventsWorldData extends SurvivorMissions
{
	...
	*/	MissionEvents.Insert("Horde Tulga east Residential_3");								MissionPositions.Insert("12897.8 172.8 4430.5");
	...
	static bool GetBuildingsAtLoc( string MBuilding, string MLocation, out array<vector> BuildingPosList )
	{
		...
		else if ( MBuilding == "Land_Castle_Bergfrit")
		{
			if ( MLocation == "Zub")					BuildingPosList.Insert("6552.96 395.58 5597.88");
			else if ( MLocation == "Black_Mountain")		BuildingPosList.Insert("10266.48 380.62 12029.61");
			else if ( MLocation == "Krona")				BuildingPosList.Insert("1383.21 317.23 9258.66");
			else return false;			//No match by location
		}
		...
		else if ( MBuilding == "none")
		{
			if ( MLocation == "Western_side_of_North_East_Airfield")			BuildingPosList.Insert("11897.7 140.012 12609.1");
			else if ( MLocation == "Eastern_side_of_North_East_Airfield")		BuildingPosList.Insert("12378 140.012 12413.3");
			else if ( MLocation == "North_end_of_NWAF")							BuildingPosList.Insert("4115 339.012 10830");
			else if ( MLocation == "South_end_of_NWAF")							BuildingPosList.Insert("4812 339.012 9617");
			else if ( MLocation == "NorthWest_end_of_Balota")					BuildingPosList.Insert("4905.53 9.512 2580.63");
			else if ( MLocation == "SouthEast_end_of_Balota")					BuildingPosList.Insert("5239.19 9.512 2181.18");
			else return false;			//No match by location
		}
	...
	static bool PrimaryMissionCHK( string type, vector position , int nr )
	{
		...
		else if ( type == "NigerianPrince")			building = "Land_Misc_TrailRoof_Small"; 
		...
		else if ( type == "PopSmoke")				building = "Land_House_1W05_Yellow";
		else 
		{
